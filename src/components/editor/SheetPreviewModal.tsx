...
export function SheetPreviewModal({ open, onOpenChange }: SheetPreviewModalProps) {
    ...
    }, [elements, sequentialConfig, csvData, dataMode, open]);

    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[90vw] max-h-[90vh] p-0">
                <DialogHeader className="px-4 pt-4 pb-2">
                    <DialogTitle>Preview da Chapa</DialogTitle>
                </DialogHeader>
                ...
                <div className="flex flex-col h-[calc(90vh-80px)]">
                    <div className="flex items-center justify-between px-4 py-2 border-b border-border">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-muted-foreground w-12 text-right">{previewZoom}%</span>
                        </div>
                    </div>
